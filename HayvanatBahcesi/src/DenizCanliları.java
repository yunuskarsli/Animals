public class DenizCanliları extends Animals{
    private String hayvan1 = "balina";
    private String hayvan2 = "dolphin";
    private String hayvan3 = "fok";

    public DenizCanliları(String hayvan1, String hayvan2, String hayvan3) {
        this.hayvan1 = hayvan1;
        this.hayvan2 = hayvan2;
        this.hayvan3 = hayvan3;
    }

    public DenizCanliları() {
